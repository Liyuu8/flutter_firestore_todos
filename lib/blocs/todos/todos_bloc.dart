...
class TodosBloc extends Bloc<TodosEvent, TodosState> {
  ...
  StreamSubscription _todosSubcription;
  ...
  Stream<TodosState> mapEventToState(TodosEvent event) async* {
    if(event is LoadTodos) {
      ...
      yield* _mapToggleAllTodoToState();
  ...
  Stream<TodosState> _mapLoadTodosToState() async* {
    ...
    _todosSubcription = _todosRepository.todos().listen(
  ...
  Stream<TodosState> _mapToggleAllTodoToState() async* {
  ...
  Stream<TodosState> _mapClearCompletedToState() async* {
    ...
    if(currentState is TodosLoaded) {
      final List<Todo> completedTodos = currentState.todos
          .where((todo) => todo.complete).toList();
